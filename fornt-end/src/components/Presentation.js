  ...
  render() {
    return (
      <div>
        ...
        <div className="container mt-3 shadow-container p-3 mb-5 rounded bg-info" id="nosotros">
          <div className="row">
            <div className="col-md-8">
              <h2 className="mt-4 text-tittles">CENTRO CULTURAL "MARÍA ELENA WALSH"</h2>
              <p className="mt-4 text-stiles">Nuestro Centro Cultural nace con la misión de convertirse en un referente local en el área de la cultura. Es un espacio de encuentro. Es un "Club" de amigos con un importante interés por la cultura en todas sus formas. Es un espacio de formación personal, de trascendencia, de superación.
