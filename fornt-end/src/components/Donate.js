...
class Donate extends Component {
    render() {
        return (
                ...
                <div className="container mt-3 shadow-container p-3 mb-5 rounded bg-donate" id="nosotros">
                    <div className="row">
                        <div className="col-md-7">
                            ...
                            <p className="mt-3 text-stiles">La Fundación tiene Personería Jurídica, es Entidad de Bien Público,
                            ...
                            <p className="mt-3 text-stiles">Los tratamientos de los nenes, los medicamentos, el material didáctico,
                            ...
                            <p className="mt-3 text-stiles">Cenas a beneficio, bingos solidarios,
